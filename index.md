...
My dissertation examines how native and non-native speakers perceive and process emotional information through semantics and prosody in a tonal language——Mandarin Chinese, and investigates how semantics influences the perception of emotional prosody in native and non-native speakers. I also utilize [functional Magnetic Resonance Imaging (fMRI)](https://en.wikipedia.org/wiki/Functional_magnetic_resonance_imaging) to explore whether native speakers and non-native speakers use similar brain mechanisms to process semantics and emotional prosody in speech. 
