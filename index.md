...
My dissertation examines how native and non-native speakers perceive and process emotional information through semantics (linguistic cue) and prosody (paralinguistic cue) in a tonal language—Mandarin Chinese. Furthermore, I investigate how semantics influences the perception of emotional prosody for both native and non-native speakers. I also utilize [functional Magnetic Resonance Imaging (fMRI)](https://en.wikipedia.org/wiki/Functional_magnetic_resonance_imaging) to explore whether native speakers and non-native speakers use similar brain mechanisms to process semantics and emotional prosody in speech. 
...
- **Xiao, C.**, & Liu, J. (in press). The perception of emotional prosody in Mandarin Chinese words and sentences. *Second Language Research*.
